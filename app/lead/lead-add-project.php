                                ...
                                <div class="col-sm-12 col-lg-9 centered">
                                            <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <form action="../../controllers/addproject.php" method="post" class="form-horizontal" role="form" onsubmit="return getContent()">
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <input type="text" id="form-field-2 headline" name="projectname" placeholder="Headline for the timeline" class="col-xs-12 col-sm-10" />
                                                                    </div>
                                                                </div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-3"> Body: </label>
                                                                    <div class="col-sm-8">
                                                                 ...
                                                                 <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <input type="text" id="form-field-4 media" name="main-media" placeholder="Media URL" class="col-xs-12 col-sm-10" />
                                                                    </div>
                                                                </div>
                                                                 <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-5"> Media Credit: </label>
                                                                    <div class="col-sm-8">
                                                                        <input type="text" id="form-field-5 credit" name="credit-media" placeholder="Credit" class="col-xs-12 col-sm-10" />
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-6"> Media Caption: </label>
                                                                    <div class="col-sm-8">
                                                                        <input type="text" id="form-field-6 caption" name="caption-media" placeholder="Caption" class="col-xs-12 col-sm-10" />
                                                                    </div>
                                                                </div>
                                                            </fieldset>
