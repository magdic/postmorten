...
$BASE_URL = 'http://localhost:8888/phpcodes/postmorten/app/pm/';
                                    ...
                                    <h1>
                                        Project Options 
                                            <small>
                                                ...
                                                <a href="timelines/timeline.php?id=<?php echo $idProject; ?>" class="btn btn-xs btn-success">See the Timeline</a>
                                            </small>
                                            <small>
                                                <i class="icon-double-angle-right"></i>
                                                <a href="<?php echo $BASE_URL; ?>pm-edit-project.php?id=<?php echo $idProject;?>" class="btn btn-xs btn-info boxer button small">Edit Project</a>
                                            </small>
                                            <small>
                                                <i class="icon-double-angle-right"></i>
                                                <a href="<?php echo $BASE_URL; ?>pm-delete-project.php?id=<?php echo $idProject;?>" class="btn btn-xs btn-danger boxer button small" data-boxer-height="206" data-boxer-width="305">Delete Project</a>
                                            </small>
                                    </h1>
                                </div>
                            <div class="row">
                            ...
                            <tr class="del<?php echo $row['idtimelines']; ?>">
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                        <a class="green boxer button small" href="<?php echo $BASE_URL; ?>pm-edit-timeline.php?id=<?php echo $row['idtimelines'].'&&project='.$idProject; ?>">
                                            <i class="icon-pencil bigger-130"></i>
                                        </a>

                                        <a href="<?php echo $BASE_URL; ?>pm-delete-timeline.php?id=<?php echo $row['idtimelines'].'&&project='.$idProject; ?>" class="boxer button small" data-boxer-height="206" data-boxer-width="305" >
