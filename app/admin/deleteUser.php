...
<body>
<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front ui-dialog-buttons ui-draggable" tabindex="-1" role="dialog" aria-describedby="dialog-confirm" aria-labelledby="ui-id-27" style="height: 100%; width: 100%; top: 275px; left: 570px; display: block;">
	...
	<div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
		<div class="center">
			<a href="../../controllers/deleteUsers.php?id=<?php echo $id; ?>" class="btn btn-danger btn-xs ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"><span class="ui-button-text"><i class="icon-trash bigger-110"></i>&nbsp; Delete</span></a>
