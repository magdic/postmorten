                      ...
                      <div class="itemdiv dialogdiv">
                        <div class="body">
                          ...
                          <span>
                            ...
                            <a type="button" class="btn btn-sm btn-danger no-radius del-conv" id="<?php echo $idComment; ?>"> Delete </a> 
                                ...
                                <div class="comment_ui">
                                  ...
                                  <div class="comment_text">
                                    <div  class="del<?php echo $c_id; ?> comment_actual_text">
                                      <div id="sssss">
                                      	<a type="button" class="btn btn-sm btn-danger no-radius del-subcomment" id="<?php echo $c_id; ?>"> Delete </a> 
          ...
          var timeline_config = {
           ...
           font: "PTSerif-PTSans"
			...
			$(document).ready( function() {
			    ...
			    $('.del-conv').click( function() {

			        var idConv = $(this).attr("id");
			 
			        if(confirm("Are you sure you want to delete this Conversation?")){
			            $.ajax({
			                type: "POST",
			                url: "comments/deleteConv.php",
			                data: ({idConv: idConv}),
			                cache: true,
			                success: function(html){
			                    $(".del"+idConv).fadeOut('slow'); 
			                } 
			            }); 
			        }else{
			            return true;}
